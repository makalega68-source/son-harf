...
-- This migration is already recorded/applied in the live son-harf project; keeping the exact
-- versioned source in Git restores repository/database migration parity for fresh environments.
