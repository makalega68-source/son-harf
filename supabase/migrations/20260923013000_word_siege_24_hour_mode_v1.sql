...
-- Kelime Kuşatması classic matchmaking gains a real 24-hour turn pool.
-- Existing 12-hour and legacy 72-hour pools remain compatible.
...
alter table public.word_siege_games
  ...
  check (turn_duration_hours in (12,24,72));
