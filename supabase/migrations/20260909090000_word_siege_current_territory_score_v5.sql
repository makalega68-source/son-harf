-- Word Siege v5: permanent word points + current owned territory.
-- Each currently owned cube is worth exactly 2 points. Rival captures reduce only cubes that
-- actually change ownership; rival neutral captures never subtract previously earned word points.
...
begin
  ...
  -- Authoritative score: permanent word score + cubes CURRENTLY owned * 2.
