-- Word Siege v5 bridge / 3: keep preview/prevalidation geometry aligned with the 15x15 submit core.
...
begin
  ...
  v_main_cells := private.word_siege_collect_cells_v1(
    ...
    case when p_horizontal then 1 else 15 end
  );
  ...
  foreach v_index in array v_indices loop
    v_cross_cells := private.word_siege_collect_cells_v1(
      ...
      case when p_horizontal then 15 else 1 end
    );
