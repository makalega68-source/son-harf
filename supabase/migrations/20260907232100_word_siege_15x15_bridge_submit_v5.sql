-- Word Siege v5 bridge / 2: canonical 15x15 submit implementation.
-- Dictionary validation and Scrabble-style scoring remain unchanged; only geometry is upgraded.
