...
class UnifiedThemeSourceContractTest {
    @Test
    fun activeUnifiedShellUsesSharedMatureThemeAndPremierKeepsHighLegibilityArenaPalette() {
        ...
        assertTrue(theme.contains("Color(0xFFF6F4EE)"))
        assertTrue(theme.contains("Color(0xFF285943)"))
        assertTrue(theme.contains("Color(0xFF77977F)"))
