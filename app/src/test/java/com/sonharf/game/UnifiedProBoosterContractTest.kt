...
class UnifiedProBoosterContractTest {
    ...
    fun retiredClassicRuntimeCannotReenterStartupPath() {
        ...
        val professional = projectFile("app/src/main/java/com/sonharf/game/ProfessionalUnifiedApp.kt").readText()

        assertTrue(startup.contains("ProfessionalUnifiedApp("))
        assertTrue(professional.contains("ProfessionalDestination.PRO -> UnifiedProVipScreen"))
