...
class WordSiegePanAreaContractTest {
    ...
    @Test fun boardKeepsReadableOwnershipAndTapPlacementContract() {
        ...
        assertTrue(pan.contains("PanSiegeMine = Color(0xFF32845E)"))
        assertTrue(pan.contains("PanSiegeRival = Color(0xFFC85A54)"))
        ...
        assertTrue(pan.contains("Color(0xFF171C1B)"))
        assertTrue(pan.contains("FontFamily.SansSerif"))
        assertTrue(pan.contains("Color(0xFFE3D6B0)"))
