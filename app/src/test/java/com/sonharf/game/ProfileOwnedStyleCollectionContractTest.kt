...
class ProfileOwnedStyleCollectionContractTest {
    @Test fun ownedCollectionIsCategorizedAndSurvivesStoreRotation() {
        ...
        assertTrue(blackMigration.contains("'theme_black'"))
        assertTrue(blackMigration.contains("game_theme_id = null"))
        assertTrue(blackMigration.contains("'theme_dark_arena'"))
