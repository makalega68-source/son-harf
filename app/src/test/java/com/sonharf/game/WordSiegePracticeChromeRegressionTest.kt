...
class WordSiegePracticeChromeRegressionTest {
    ...
    fun practiceHeaderProfilesMapControlAndFooterKeepCompactPhoneAlignment() {
        ...
        assertFalse(practice.contains("KELİME TAHTI"))
        assertTrue(practice.contains("PurchasedGameBackdrop(Modifier.matchParentSize())"))
        ...
        assertTrue(practice.contains("PurchasedUiAsset.ICON_CHECK"))
        assertFalse(practice.contains("KUŞATMA +"))
