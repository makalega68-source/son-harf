...
object SonHarfPreferences {
    ...
    // G5.4 oyun dili. Varsayılan Türkçe. UI dilinden bağımsızdır.
    fun gameLanguage(context: Context): String =
        prefs(context).getString(GAME_LANGUAGE, "tr")
            ?.takeIf { it in setOf("tr", "en") } ?: "tr"
